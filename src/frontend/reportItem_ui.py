...
"    }")
        ...
        self.dateFoundEdit.setGeometry(QRect(10, 220, 271, 41))
        font2 = QFont()
        font2.setPointSize(12)
        self.dateFoundEdit.setFont(font2)
        self.itemNameEdit = QLineEdit(self.itemPage)
        self.itemNameEdit.setObjectName(u"itemNameEdit")
        self.itemNameEdit.setGeometry(QRect(10, 140, 301, 41))
...
"    }")
        ...
        self.pushButton.setGeometry(QRect(460, 470, 101, 31))
...
"    }")
        ...
        self.label_14.setGeometry(QRect(370, 110, 191, 23))
        ...
        self.descriptionEdit.setGeometry(QRect(10, 300, 561, 61))
...
"    }")
        ...
        self.locationFoundEdit.setGeometry(QRect(310, 220, 271, 41))
...
"    }")
        ...
        self.labelImagePreview = QLabel(self.personPage)
        self.labelImagePreview.setObjectName(u"labelImagePreview")
        self.labelImagePreview.setGeometry(QRect(30, 370, 421, 221))
        ...
        self.uploadImageButton.setGeometry(QRect(460, 450, 75, 31))
...
"    }")
    ...
    def retranslateUi(self, ReportItemDialog):
        ...
        self.pushButton.setText(QCoreApplication.translate("ReportItemDialog", u"Upload ", None))
        ...
        self.backButton.setText(QCoreApplication.translate("ReportItemDialog", u"B", None))
        ...
        self.labelImagePreview.setText(QCoreApplication.translate("ReportItemDialog", u"No Image Selected", None))
        self.uploadImageButton.setText(QCoreApplication.translate("ReportItemDialog", u"Upload", None))
    # retranslateUi
