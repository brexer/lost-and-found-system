...
"    }")
        ...
        self.locationFoundEdit.setGeometry(QRect(310, 370, 271, 41))
...
"    }")
        ...
        self.dateFoundEdit.setGeometry(QRect(20, 370, 271, 41))
...
"    }")
    ...
    def retranslateUi(self, SurrenderItemDialog):
        ...
        self.label_4.setText(QCoreApplication.translate("SurrenderItemDialog", u"Category", None))
