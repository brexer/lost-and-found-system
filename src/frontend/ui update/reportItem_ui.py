...
"    }")
        ...
        self.label_11.setGeometry(QRect(160, 0, 291, 81))
        font3 = QFont()
...
"    }")
        ...
        self.label.setGeometry(QRect(160, 0, 291, 81))
...
"    }")
    ...
    def retranslateUi(self, ReportItemDialog):
        ...
        self.label_4.setText(QCoreApplication.translate("ReportItemDialog", u"Description", None))
        ...
        self.label_13.setText(QCoreApplication.translate("ReportItemDialog", u"Person Details", None))
