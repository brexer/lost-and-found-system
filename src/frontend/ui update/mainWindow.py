...
"            }")
        ...
        self.updateClaimButton.setGeometry(QtCore.QRect(990, 850, 112, 34))
...
"            }")
        ...
        self.reportItem = QtWidgets.QPushButton(self.sidebar)
        self.reportItem.setStyleSheet("color: rgb(255, 255, 255);")
